...
//   FaWineGlass, 
//   FaPizzaSlice, 
//   FaUser,      // ✅ VERIFIED - person/chef
//   FaDrumstickBite, // ✅ VERIFIED - chicken/drumstick  
//   FaHotdog     // ✅ VERIFIED
...
//       {/* FLOATING FOOD ICONS - ALL VERIFIED ICONS */}
...
//       {/* COMPLETE FORM - SAME AS ORIGINAL */}
...
//                     className="absolute inset-y-0 right-2 flex items-center px-3 text-[11px] text-sky-200 hover:text-sky-100"
//                   >
...
//                 type="submit"
//                 disabled={isLoading}
//                 className="group w-full rounded-xl bg-gradient-to-r from-sky-400 via-blue-500 to-emerald-400 py-2.5 text-sm font-semibold text-slate-950 shadow-lg hover:shadow-sky-400/70 hover:-translate-y-0.5 transition-all disabled:opacity-70"
//               >
...
//               Don't have an account? <button type="button" className="font-semibold text-sky-200 hover:text-sky-100">Register now</button>
//             </p>
//           </div>
//         </div>
//       </div>
